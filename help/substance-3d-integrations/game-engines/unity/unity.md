...
>[!WARNING]
>
> Be sure to check the [Optimization Guidelines](optimization-guidelines/optimization-guidelines.md) page before authoring custom Substance materials.
...
* [Changing parameters](changing-parameters/changing-parameters.md) — Parameters for the Substance material are accessible on the Substance Graph Object (SGO).
* [Generated Textures (Packing)](generated-textures-pac/generated-textures-packing.md) — The Generated Textures show the outputs from the Substance that are computed by the Substance Engine to create textures
