---
title: "Maxwell - Substance Painter | Ecosystem and Plug-ins"
description: "Ecosystems and Plugins > Renderers > Maxwell > Maxwell - Substance Painter"
---

# Maxwell - Substance Painter

Substance Painter 2020.1 (6.1.0) supports Maxwell [Output Templates](../../../../substance-3d-painter/getting-started/export/export.md) for metallic/roughness and specular/glossiness. You can simply export using the Maxwell Output Template**.   
