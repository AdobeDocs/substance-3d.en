...
>   * In Substance Painter the normal format can be changed in the [project configuration](https://experienceleague.adobe.com/en/docs/substance-3d-painter/using/interface/project-configuration).
>   * In Substance Designer the normal format can be changed in the [project preferences](https://experienceleague.adobe.com/en/docs/substance-3d-designer/using/workspace/preferences/project-settings).
